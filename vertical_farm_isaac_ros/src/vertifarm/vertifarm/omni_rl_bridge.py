...
#list of topics
ENV_PATH = "/media/ashik/robotics/IsaacSim-nonros_workspaces/src/rl_mine/vertical_farm_isaac_ros/src/vertifarm/omni_assets/Collected_farmer/farmer.usd"
...
class OmniRosBridge():
    ...
    def run_simulation(self, ):
        ...
        writer = rep.writers.g0et("RtxLidar" + "ROS2PublishPointCloud")
