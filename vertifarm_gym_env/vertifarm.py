...
class FrankaCabinet(VecTask):
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        # obs sapace, actions space, obs size, action size,
        # reward based initialisation
        self.cfg = cfg
        ...
        # TODO add obs_space and action space, initialize variables
        # check the config
        if self.num_props > 0:
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        #not really needed or can call sim
    ...
    def pre_physics_step(self, actions):
        #leave these or use instead of step
